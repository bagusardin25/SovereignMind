            ...
            <div className="pt-2 space-y-4">
              <label className="flex items-center justify-between cursor-pointer group">
                ...
                <div className="relative">
                  ...
                  <div className={`block w-10 h-6 rounded-full transition-colors ${notifications.email ? 'bg-[--color-agent-cmo]' : 'bg-[--color-surface-bright]'}`}></div>
              ...
              <label className="flex items-center justify-between cursor-pointer group">
                ...
                <div className="relative">
                  ...
                  <div className={`block w-10 h-6 rounded-full transition-colors ${notifications.slack ? 'bg-[--color-agent-cmo]' : 'bg-[--color-surface-bright]'}`}></div>
              ...
              <label className="flex items-center justify-between cursor-pointer group">
                ...
                <div className="relative">
                  ...
                  <div className={`block w-10 h-6 rounded-full transition-colors ${notifications.telegram ? 'bg-[--color-agent-cmo]' : 'bg-[--color-surface-bright]'}`}></div>
              ...
              <div className="pt-4 border-t border-white/5">
                 <label className="flex items-center justify-between cursor-pointer group">
                  ...
                  <div className="relative">
                    ...
                    <div className={`block w-10 h-6 rounded-full transition-colors ${notifications.urgentOnly ? 'bg-red-500' : 'bg-[--color-surface-bright]'}`}></div>
